...
export default function WaitlistForm({ defaultEmail = '', source }: WaitlistFormProps) {
          ...
          {status === 'success' ? (
            ...
            >
              ...
              <div className="flex flex-col gap-sm sm:flex-row sm:items-center sm:justify-between">
                <button type="submit" className={cn(buttons.primary, 'w-full sm:w-auto')} disabled={disabled}>
